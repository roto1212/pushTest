...
//	1페이지 부량의 글목록과 페이지 작업에 사용할 8개의 변수를 초기화 시키는 클래스
public class GuestbookList {
//	1페이지 분량의 글(GuestbookVO)목록을 기억하는 배열목록
...
//	pageSize, totalCount, currentPage를 매개변수로 넘겨받아 초기화 시키고 나머지 변수는 계산을 해서 초기화 시키는 생성자 
